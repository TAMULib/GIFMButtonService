<a name="readme-top"></a>
# Contributing To GIFMButton

Though GIFMButton is developed and maintained by Texas A&M University Libraries, we welcome community contributions.
Involvement in GIFMButton can take many forms:

<div align="right">(<a href="#readme-top">back to top</a>)</div>

## Using

Deploying GIFMButton and trying it out at your own institution is itself a way of contributing to the development process.
...
Once you are using GIFMButton the creation of new issues through GitHub is a major method of contribution towards GIFMButton development.
...
Each *PR* will need to be reviewed by a GIFMButton developer.
...
If you have any additional questions please contact the GIFMButton developers at [helpdesk@library.tamu.edu][helpdesk-email].
