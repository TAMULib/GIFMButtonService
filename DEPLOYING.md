<a name="readme-top"></a>
# Get It For Me Button Service Deployment Guide
...
<sub>_* Note: `-t gifmservice` and `-it gifmservice` may be changed to another tag name as desired, such as `-t developing_on_this` and `-it developing_on_this`._</sub><br>
